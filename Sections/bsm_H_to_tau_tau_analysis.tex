...
The search for additional Higgs bosons had previously been performed with data collected in 2016 ($39 \sifb$) and results were consistent with the SM background prediction \cite{}.
...
To resolve this issue a likelihood-based method named SVFit algorithm is used \cite{}.
This helps to separate signal events from the Z boson peak in this region. \\

Finally the SM Higgs optimisation procedure is taken from the CMS SM $H \rightarrow \tau\tau$ analysis detailed in Ref.~\cite{}.
...
Plots of the agreement from these dedicated samples with data are shown in Figure~\ref{}.
...
In fully simulated events, a specific trigger inefficiency caused by a shift in the timing of the inputs of the ECAL L1 trigger in the region at $\abs{\eta}>2.0$ during the 2016 and 2017 data taking.
This effect is named prefiring.
This resulted in a loss of efficiency for events containing an electron or jet with $p_T$ larger than ${\approx}50$ or ${\approx}100)$ GeV respectively, in the region of $2.5<\abs{\eta}<3.0$. 
