...
Offline requirements are criteria that are applied once the data has been stored after passing the trigger selections.
...
Figures~\ref{fig:low_mass_postfit} and \ref{fig:high_mass_postfit} show the distributions in the most sensitive analysis categories.
...
\begin{figure}[p!]
\centering
    \subfloat[]{\includegraphics[width=0.65\textwidth]{Figures/significance_plot_ggH.pdf}} \\
    \subfloat[]{\includegraphics[width=0.65\textwidth]{Figures/significance_plot_bbH.pdf}}
