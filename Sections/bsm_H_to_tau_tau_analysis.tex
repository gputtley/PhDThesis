...
\begin{figure}[!hbtp]
\centering
    \subfloat[]{\includegraphics[width=0.4\textwidth]{Figures/postfit_lowmass_tt_nobtag_mediumpT-cropped.pdf}}
    \subfloat[]{\includegraphics[width=0.4\textwidth]{Figures/postfit_lowmass_tt_nobtag_highpT-cropped.pdf}} \\
    \subfloat[]{\includegraphics[width=0.4\textwidth]{Figures/postfit_lowmass_lt_nobtag_mediumpT-cropped.pdf}}
    \subfloat[]{\includegraphics[width=0.4\textwidth]{Figures/postfit_lowmass_lt_nobtag_highpT-cropped.pdf}} \\
    \subfloat[]{\includegraphics[width=0.4\textwidth]{Figures/postfit_lowmass_em_nobtag_mediumpT-cropped.pdf}}
    \subfloat[]{\includegraphics[width=0.4\textwidth]{Figures/postfit_lowmass_em_nobtag_highpT-cropped.pdf}}
...
\begin{figure}[!hbtp]
\centering
    \subfloat[]{\includegraphics[width=0.42\textwidth]{Figures/postfit_highmass_tt_nobtag-cropped.pdf}}
    \subfloat[]{\includegraphics[width=0.42\textwidth]{Figures/postfit_highmass_tt_btag-cropped.pdf}} \\
    \subfloat[]{\includegraphics[width=0.42\textwidth]{Figures/postfit_highmass_lt_nobtag_tightmT-cropped.pdf}}
    \subfloat[]{\includegraphics[width=0.42\textwidth]{Figures/postfit_highmass_lt_btag_tightmT-cropped.pdf}} \\
    \subfloat[]{\includegraphics[width=0.42\textwidth]{Figures/postfit_highmass_em_nobtag_mediumdzeta-cropped.pdf}}
    \subfloat[]{\includegraphics[width=0.42\textwidth]{Figures/postfit_highmass_em_btag_mediumdzeta-cropped.pdf}}
