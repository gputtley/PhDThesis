...
Different than for muons, the isolation used is based on the photon, neutral and charged hadron \ac{PF} candidates within a smaller cone size of $\Delta R<0.3$ of the selected electron.
...
\begin{table}[h]
    ...
    \begin{tabular}{|c|c|}
         ...
         \hline
    \end{tabular}
    \caption[Branching fractions for the $\tau$ lepton.]{Measured branching fractions for the $\tau$ lepton. h represents a charged hadron, typically either a pion or a kaon~\cite{ParticleDataGroup:2022pth}.}
    \label{tab:tau_decay}
\end{table}
