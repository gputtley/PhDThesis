...
The number of seeds dictates how many \say{\ac{PF} clusters} are formed from a topological cluster.
...
Initially, global muons within the block are converted into \say{\ac{PF} muons} if their energy deposits in the \ac{ECAL} and \ac{HCAL} align with the track. 
...
Unclassified \ac{ECAL} and \ac{HCAL} clusters give rise to \say{\ac{PF} photons} and \say{\ac{PF} neutral hadrons} respectively, using the calibration procedure applied to \ac{HCAL} clusters.
...
\begin{figure}[t]
\centering
    \subfloat[]{\includegraphics[width=0.48\textwidth]{Figures/hps_f.png}}
    \subfloat[]{\includegraphics[width=0.48\textwidth]{Figures/hps_g.png}} \\
